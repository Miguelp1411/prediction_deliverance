...
from proyectos_hibridos.hybrid_schedule_project_v3.src.hybrid_schedule.data.features import (
    GlobalContext,
    SeriesBundle,
...
from proyectos_hibridos.hybrid_schedule_project_v3.src.hybrid_schedule.retrieval.template_retriever import (
    build_empirical_candidate_bank,
    build_template_week,
    gather_empirical_candidates,
    propose_extra_slots,
)
from proyectos_hibridos.hybrid_schedule_project_v3.src.hybrid_schedule.scheduler import solve_week_schedule
