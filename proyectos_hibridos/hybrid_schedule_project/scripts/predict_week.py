...
from hybrid_schedule.utils import get_device, load_checkpoint, macroblock_bins_from_minutes, num_macroblocks_per_day, read_checkpoint
...
def main() -> None:
    ...
    bins_per_day = (24 * 60) // int(ckpt_cfg['calendar']['bin_minutes'])
    macroblock_bins = macroblock_bins_from_minutes(int(ckpt_cfg['calendar']['bin_minutes']), int(ckpt_cfg['models']['temporal'].get('macroblock_minutes', 60)))
