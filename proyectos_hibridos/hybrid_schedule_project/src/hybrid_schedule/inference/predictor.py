...
from proyectos_hibridos.hybrid_schedule_project.src.hybrid_schedule.data.features import GlobalContext, SeriesBundle, build_future_history_tensor, per_task_recent_stats
from proyectos_hibridos.hybrid_schedule_project.src.hybrid_schedule.retrieval.template_retriever import build_template_week, propose_extra_slots
from proyectos_hibridos.hybrid_schedule_project.src.hybrid_schedule.scheduler import solve_week_schedule
from proyectos_hibridos.hybrid_schedule_project.src.hybrid_schedule.utils import compose_week_bin, macroblock_bins_from_minutes, num_macroblocks_per_day
