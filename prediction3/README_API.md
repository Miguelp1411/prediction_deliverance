...
Checkpoint del modelo que predice **start_bin semanal conjunto y duración** para cada ocurrencia.
...
- predice:
  - `start_logits` → bin temporal semanal completo (0..2015);
  - `pred_duration_norm` → duración normalizada.

Resultado:
- para cada ocurrencia se obtiene una propuesta de slot semanal completo y duración.
