...
def predict_next_week(occurrence_model, temporal_model, prepared, target_week_idx, device, use_repair: bool = False, auxiliary_corrector=None):
    ...
    if auxiliary_corrector is not None:
        final_predictions = auxiliary_corrector.apply(prepared, target_week_idx, final_predictions)
...
def main():
    ...
    if not args.disable_auxiliary_corrector:
        from auxiliary_corrector import maybe_load_auxiliary_corrector
