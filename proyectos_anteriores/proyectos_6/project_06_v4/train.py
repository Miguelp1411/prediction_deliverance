...
from proyectos_anteriores.proyectos_6.project_06_v4.data.datasets import OccurrenceDataset, TemporalDataset, build_occurrence_count_lookup, build_split_indices
from proyectos_anteriores.proyectos_6.project_06_v4.data.io import load_tasks_dataframe
from proyectos_anteriores.proyectos_6.project_06_v4.data.preprocessing import prepare_data, serialize_metadata
from proyectos_anteriores.proyectos_6.project_06_v4.evaluation.weekly_stats import evaluate_weekly_predictions
from proyectos_anteriores.proyectos_6.project_06_v4.models.occurrence_model import StructuredOccurrenceModel, TaskOccurrenceModel
from proyectos_anteriores.proyectos_6.project_06_v4.models.temporal_model import TemporalAssignmentModel
from proyectos_anteriores.proyectos_6.project_06_v4.predict import predict_next_week
from proyectos_anteriores.proyectos_6.project_06_v4.training.engine import evaluate_epoch, fit_model
from proyectos_anteriores.proyectos_6.project_06_v4.training.losses import OccurrenceLoss, TemporalLoss
from proyectos_anteriores.proyectos_6.project_06_v4.training.metrics import occurrence_metrics, temporal_metrics
from proyectos_anteriores.proyectos_6.project_06_v4.utils.runtime import resolve_device
from proyectos_anteriores.proyectos_6.project_06_v4.utils.serialization import save_checkpoint
...
def main():
    ...
    try:
        if hasattr(torch, 'compile'):
            occurrence_model = torch.compile(occurrence_model, mode='reduce-overhead')
            temporal_model = torch.compile(temporal_model, mode='reduce-overhead')
            print('  torch.compile activado para ambos modelos')
