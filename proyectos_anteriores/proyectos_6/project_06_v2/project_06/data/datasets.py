...
from proyectos_anteriores.proyectos_6.project_06_v2.project_06.config import TRAIN_RATIO, WINDOW_WEEKS, bins_per_day
from proyectos_anteriores.proyectos_6.project_06_v2.project_06.data.preprocessing import PreparedData, build_temporal_context, week_to_feature_vector
        ...
        for i, week_idx in enumerate(target_week_indices):
            if show_progress:
                print_progress_inline(
                    ...
                    i + 1,
                    total_weeks,
                    extra=f"muestras={len(self.samples)}",
                )
