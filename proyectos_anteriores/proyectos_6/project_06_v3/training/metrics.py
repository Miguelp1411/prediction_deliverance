...
from proyectos_anteriores.proyectos_6.project_06_v3.config import BIN_MINUTES, START_TOPK_TOLERANCE_BINS, bins_per_day, num_time_bins
...
def decode_predicted_start_bins(outputs: dict[str, torch.Tensor]) -> torch.Tensor:
    ...
    pred_start = pred_day.long() * bins_per_day() + pred_time.long()
