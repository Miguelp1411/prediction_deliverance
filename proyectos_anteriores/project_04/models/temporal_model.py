...
from proyectos_anteriores.project_04.config import num_day_classes, num_time_of_day_classes
from proyectos_anteriores.project_04.models.blocks import SequenceContextEncoder
...
class TemporalAssignmentModel(nn.Module):
    def __init__(
        ...
        self.time_head = nn.Linear(hidden_size * 2, num_time_of_day_classes())
