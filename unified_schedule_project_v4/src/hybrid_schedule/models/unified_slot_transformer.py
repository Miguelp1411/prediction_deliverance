...
class UnifiedSlotTransformer(nn.Module):
    def __init__(
        ...
        self.bins_per_week = int(7 * self.bins_per_day)
        ...
        self.week_time_head = nn.Linear(hidden_size, self.bins_per_week)
    ...
    def forward(
        ...
        week_time_logits = self.week_time_head(fused)
        ...
        return {
            ...
            'week_time_logits': week_time_logits,
