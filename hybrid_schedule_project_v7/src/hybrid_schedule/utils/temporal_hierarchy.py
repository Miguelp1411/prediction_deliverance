...
def clip_day_offset(offset: int | float, radius: int) -> int:
    return int(max(-radius, min(radius, round(float(offset)))))


def clip_local_offset(offset: int | float, radius: int) -> int:
    return int(max(-radius, min(radius, round(float(offset)))))


def day_offset_to_index(offset: int | float, radius: int) -> int:
    return clip_day_offset(offset, radius) + int(radius)


def index_to_day_offset(index: int | float, radius: int) -> int:
    return int(round(float(index))) - int(radius)


def local_offset_to_index(offset: int | float, radius: int) -> int:
    return clip_local_offset(offset, radius) + int(radius)


def index_to_local_offset(index: int | float, radius: int) -> int:
    return int(round(float(index))) - int(radius)
