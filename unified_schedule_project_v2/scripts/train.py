...
def infer_max_slots_by_task(
    ...
    per_task_counts = [[] for _ in range(num_tasks)]
...
def main() -> None:
    ...
    if cfg['calendar'].get('max_slots_by_task') is None:
        max_slots_by_task, global_max_slots = infer_max_slots_by_task(context, train_indices)
