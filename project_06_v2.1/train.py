...
def print_temporal_monitor_guide():
    ...
    print('  overlap_count     : solapes dentro de la semana predicha y por device_uid')
...
def save_training_report(path, model_name: str, state, extra: dict | None = None):
    ...
    payload = {
        ...
        'final_train_loss': float(state.final_train_loss),
        'final_val_loss': float(state.final_val_loss),
        'best_train_metrics': _to_float_dict(state.best_train_metrics),
        'best_val_metrics': _to_float_dict(state.best_val_metrics),
        'final_train_metrics': _to_float_dict(state.final_train_metrics),
        'final_val_metrics': _to_float_dict(state.final_val_metrics),
...
def main():
    ...
    print(f'  Tasks base únicas         : {len(set(prepared.task_base_names))}')
    print(f'  Devices únicos            : {len(set(prepared.task_device_uids))}')
    print(f'  Usa device_uid explícito  : {prepared.has_explicit_device_uids}')
